#!/usr/bin/python3
"""Module 4-rectangle
Defines a class Rectangle with properties width and height,
and methods to calculate the area,
perimeter, to print the rectangle, and to return
a string representation for eval().
"""
